  ...
  return (
    <main className="mx-auto w-full max-w-4xl px-6 pb-24">
      ...
      <header className="relative border-b border-hairline pt-12 pb-10">
        ...
        <h1 className="mt-6 font-display text-4xl font-black uppercase leading-[1.05] sm:text-6xl">
          Almost every one:{" "}
          <span className="stamp stamp-hero text-stamp px-3 align-middle text-3xl sm:text-5xl">Closed</span>
        </h1>
